...
import sisi.orange.view.calculate.WifiService;
...
public class TestWifiService extends ServiceTestCase<WifiService>{

	private String tag = "TestWifiService";

	public TestWifiService() {
		super(WifiService.class);
